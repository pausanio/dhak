...
/**
 * Backend Dokument form.
 *
 * @package    historischesarchivkoeln.de
 * @subpackage form
 * @author     Maik Mettenheimer
 */
class BackendDokumentForm extends BaseDokumentForm
{
    ...
    public function configure()
    {
        ...
        $this->widgetSchema->setLabels(array(
            ...
            'status' => 'Status',
            'user_description' => 'Redaktionelle Ergänzung'
        ));
        ...
        $this->widgetSchema['validated'] = new sfWidgetFormChoice(array(
            'choices' => array(
                1 => 'ja',
                0 => 'nein'
            ),
        ...
        $this->validatorSchema['validated'] = new sfValidatorPass();
        ...
        $this->validatorSchema['filename'] = new sfValidatorFile(array(
                'required' => false,
                'path' => sfConfig::get('app_dokument_user_filesystem').'/'.Dokument::ORGDIR,
