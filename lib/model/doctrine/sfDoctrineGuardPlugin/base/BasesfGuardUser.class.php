 ...
 * @method sfGuardUser           setHaProjekte()             Sets the current record's "HaProjekte" collection
 * @method sfGuardUser           setMyVerzeichnungseinheit() Sets the current record's "MyVerzeichnungseinheit" collection
 * @method sfGuardUser           setMyDokumente()            Sets the current record's "MyDokumente" collection
 * @method sfGuardUser           setMyArchiv()               Sets the current record's "MyArchiv" collection
 * 
