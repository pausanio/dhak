...
/**
 * MyDokumente filter form base class.
 *
 ...
 */
abstract class BaseMyDokumenteFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'dokument_id'       => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Dokumente'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('my_dokumente_filters[%s]');
